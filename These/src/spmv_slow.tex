...
Nous avons préféré utiliser Likwid, un outil d'analyse de performance léger.
%
Le principal avantage de Likwid est qu'il contient des profils déjà configurés.
%
Par exemple, le profil {\em MEM} nous donnera directement les mesures de bande passante mémoire locale et distante.
%
