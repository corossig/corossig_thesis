...
%
Au final, avec l'utilisation des 12 coeurs de calcul de la machine, nous obtenons des accélérations plutôt décevant, par exemple, pour les cas à 3 variables primaires, le code tourne environ 2,5x plus vite que la version séquentielle mais il utilise 12 threads.
...
%
Les autres valeurs donnent des résultats légèrement moins bons, par exemple le paramètre 4 offre une accélération de 3,35, 3,55 pour le paramètre 12 et 3,72 pour le paramètre 8.
%
...
Les deux précédents opérateurs donnent déjà des résultats, mais le meilleur opérateur pour nos matrices reste l'opérateur C.
%
