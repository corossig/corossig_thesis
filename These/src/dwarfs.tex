...
%
La classe de problème {\em structured grids} peuvent être paralléliser avec du parallélisme à base de graphe de tâches, mais il ne s'agit pas du meilleur paradigme de parallélisation pour cette classe.
%
...
%
Cette granularité est trop faible pour être traitée par un ordonnanceur logiciel.
...
%
L'algèbre linéaire creuse comporte un ensemble très vaste d'algorithmes qui ne se parallélisent pas tus de la même manière.
%
