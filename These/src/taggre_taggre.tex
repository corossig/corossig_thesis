...
En premier lieu, nous avons développé une nouvelle interface de programmation en C++ basée sur celle de Intel TBB.
%
...
vector<int> mes_taches;
for (int i = 0; i < nombres_de_lignes; i++)
  mes_taches.push_back(schema.new_task(1, i));

/* Definir les aretes du graphe */
