...
Afin d'obtenir une évaluation de la borne maximale de l'accélération possible d'obtenir sur un hardware donné, nous proposons de comparer l'accélération obtenue par une méthode de jacobi par bloc.
%
...
%
Si l'on compare les accélérations obtenues avec celles obtenues avec l'agrégation de tâches on peut voir des résultats légèrement meilleurs pour la méthode jacobi par bloc.
%
...
%
Dans le cas des processus MPI utilisée par la méthode jacobi par bloc, chaque processus a son propre espace mémoire et la localité des données est assurée sous réserve d'un placement statique et optimal des processus.
%
