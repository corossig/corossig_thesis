...
\begin{figure}[!ht]
     \begin{center}
        \subfigure[Matrice des distances entre chaque banc NUMA. Les valeurs n'ont pas d'unités et sont fournies par le constructeur. Résultat obtenu avec la commande ``numactl --hardware''.]{%
