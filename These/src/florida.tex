...
%
La matrice est plutôt petite (environ 5000 lignes), nous n'aurons donc pas beaucoup de tâches.
%
...
%
La matrice est assez grande, nous pourrons agréger des lignes ensemble.
%
...
%
Il s'agit d'une petite matrice d'environ 10000 lignes.
%
