...
%
Elle diminue quand il y a beaucoup de fautes NUMA et augmente quand les pages sont bien placées, c'est pour le surcoût de cette méthode est difficilement calculable.
%
