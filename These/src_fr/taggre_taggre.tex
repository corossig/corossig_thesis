...
\begin{figure}[!ht]
    ...
    \end{center}
    \caption{Exemple de deux agrégations, le résultat de \ref{fig:agg_invalid} ne peut pas être ordonnancé à cause du cycle. Le résultat de \ref{fig:agg_valid} peut être ordonnancé mais il y a aucun parallélisme à exploiter.}
    \label{fig:agg_basic}
\end{figure}
